  ...
  function saveSettings() {
    window.api.setSettings({
      ...
      laaRates: JSON.stringify({
        fixedFee: document.getElementById('rate-fixedFee')?.value || '320',
        escapeThreshold: document.getElementById('rate-escapeThreshold')?.value || '650',
        attendanceSocial: document.getElementById('rate-attendanceSocial')?.value || '54.57',
        attendanceUnsocial: document.getElementById('rate-attendanceUnsocial')?.value || '72.46',
        travelWaiting: document.getElementById('rate-travelWaiting')?.value || '27.29',
