...
/**
 * Local machine has records and nothing pending, but the last successful pull
 * received 0 remote rows. Other devices will stay empty until this machine
 * re-uploads (raw DB file-swap and "already synced" local state do not push).
 */
