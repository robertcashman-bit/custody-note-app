...
/**
 * Encrypt / decrypt synced integration credentials for central server storage
 * (QuickFile + optional OpenAI API key). Server stores ciphertext only —
 * decryption requires the licence key.
 */
