...
/**
 * Build offence-only payload from form data (max 4 offences).
 * @param {object} formData
 * @returns {{ offences: Array<{ details: string, statute: string, modeOfTrial: string }>, error?: string }}
 */
...
/**
 * @param {Array<{ details: string, statute: string, modeOfTrial: string }>} offences
...
/**
 * @param {{ apiKey: string, offences: Array, confirmed: boolean, model?: string, fetchImpl?: Function }} opts
 */
